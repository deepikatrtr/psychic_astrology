...
*Details of my problem:* ${contactForm.message}`;
  ...
  const faqs = [
    { q: "Is the consultation 100% confidential✦", a: "Absolutely. Every conversation with the Best Astrologer in London is treated with strict confidentiality. Your privacy is important to us." },
    { q: "How long do the remedies take to show results✦", a: "Most clients see initial positive shifts within 7-21 days, with full transformation typically within 1-3 months depending on the complexity of the issue." },
    { q: "Do I need to visit in person for a consultation✦", a: "No, Guruji serves clients globally over phone, WhatsApp and video call. Distance is no barrier to divine intervention." },
    { q: "Are your remedies safe and ethical✦", a: "Yes. All psychic and spiritual remedies are performed with positive intention and cause absolutely no harm to anyone involved." },
    { q: "What problems can you help solve✦", a: "Love and relationship issues, marriage problems, negative energy, family disputes, career and business obstacles, health concerns and more." },
    { q: "How do I begin my consultation✦", a: "Simply call +44 7722 131999, message us on WhatsApp or fill our inquiry form. Guruji will personally connect with you." }
  ];
      ...
      <section style={{
        ...
        <div className="container" style={{
          ...
          <div style={{ textAlign: 'left', zIndex: 10 }}>
            ...
            <h1 key={activeSlide} className="font-display text-gold-gradient text-shadow-gold text-popup-anim" style={{
              fontSize: '48px',
              fontWeight: '900',
              lineHeight: '1.15',
              marginBottom: '20px',
              height: '115px' // Reserve space to avoid layout shift
            }}>
        ...
        <div className="container" style={{ marginTop: '60px', zIndex: 10 }}>
          <div style={{
            display: 'grid',
            ...
            {[
              { end: 10000, suffix: "+", label: "LIVES TRANSFORMED" },
              { end: 35, suffix: "+", label: "YEARS OF MASTERY" },
              ...
              >
                ...
                <p className="font-display text-gold-gradient text-shadow-gold" style={{ fontSize: '36px', fontWeight: '900', marginBottom: '8px' }}>
                  <Counter end={stat.end} suffix={stat.suffix} />
                </p>
                <p style={{ fontSize: '10px', color: 'var(--text-muted)', letterSpacing: '0.15em', fontWeight: 'bold', textTransform: 'uppercase' }}>
                  {stat.label}
                </p>
              </div>
            ))}
        ...
        <div className="container" style={{
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <h2 className="font-display text-gold-gradient" style={{ fontSize: '36px', fontWeight: 'bold', marginBottom: '20px' }}>
              Spiritual Guidance By the Best Astrologer in London
            </h2>
            <p style={{ fontSize: '15px', color: 'var(--text-primary)', marginBottom: '15px', lineHeight: '1.7' }}>
              The Best Astrologer in London is a gifted psychic astrologer and spiritual healer with more than 35 years of mastery in solving love, relationship, marriage, family and life problems through powerful astrology, ancient mantras and spiritual remedies.
            </p>
            <p style={{ fontSize: '14px', color: 'var(--text-muted)', marginBottom: '30px' }}>
              Guided by generations of spiritual knowledge, Guruji combines deep psychic intuition with time-tested rituals to deliver lasting transformation. His guidance has brought peace, love and prosperity to thousands of families all over the world.
            </p>
            ...
            <blockquote className="glass-card" style={{
              ...
              "Every soul carries a karmic blueprint. With the right mantra, ritual and remedy, every obstacle can be dissolved - love returns, peace returns, light returns."
      ...
      <section className="section-padding" style={{
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            ...
            <h2 className="font-display text-gold-gradient" style={{ fontSize: '36px', fontWeight: 'bold' }}>
              Our Trusted 4-Step Healing Process
            </h2>
            <p style={{ color: 'var(--text-muted)', maxWidth: '600px', margin: '10px auto 0 auto', fontSize: '15px' }}>
              A proven, divine pathway from suffering to absolute transformation.
            </p>
          </div>
          ...
          <div style={{
            ...
            {[
              { n: 1, t: "Share Your Problem", d: "Reach out via WhatsApp, call or our private inquiry form. Every conversation is 100% confidential." },
              { n: 2, t: "Psychic Analysis", d: "Guruji studies your birth chart, intuitively scans your aura and identifies the spiritual root cause." },
              { n: 3, t: "Personalized Remedy", d: "A precise combination of mantras, yantras, fire ritual and personalised remedies are performed for you." },
              { n: 4, t: "Lasting Results", d: "Most clients begin to see positive shifts within 7-21 days, with full transformation in 1-3 months." }
            ].map((step, i) => (
              <div 
                key={i} 
                className="glass-card" 
              ...
              >
                ...
                <h3 className="font-display" style={{ fontSize: '18px', color: 'var(--gold-soft)', margin: '10px 0 12px 0' }}>
                  {step.t}
                </h3>
      ...
      <section className="section-padding">
        <div className="container" style={{ maxWidth: '800px' }}>
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            ...
            <p style={{ color: 'var(--text-muted)', margin: '10px auto 0 auto', fontSize: '15px' }}>
              Have questions about how psychic and spiritual guidance works✦ Find answers here.
            </p>
          </div>
